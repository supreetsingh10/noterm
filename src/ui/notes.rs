...
use crate::backend::messages::Messages;
use std::io::{stdout, Stdout};
use tui::backend::CrosstermBackend;
use tui::layout::{Constraint, Layout, Rect};
use tui::prelude::{Alignment, Direction};
use tui::style::Style;
...
fn fix_coordinates_of_notes(
    ...
    for (index, m) in msg.messages.clone().into_iter().enumerate() {
        ...
        let height = count_note_lines(m.get_message_text());
        ...
        if index == 0 {
            ...
            coord.1 = INIT_Y;
                ...
                coord.1 = coords_vec[index - max_notes_in_row as usize].1
                    + coords_vec[index - max_notes_in_row as usize].3;
        } else {
